    ...
    public static IApplicationBuilder UseContentSecurityPolicy(this IApplicationBuilder app)
    {
        ...
        app.Use(async (context, next) =>
        {
            ...
            context.Response.Headers["Content-Security-Policy"] =
                ...
                $"img-src 'self' {dasCdn} *.googletagmanager.com https://ssl.gstatic.com https://www.gstatic.com *.google-analytics.com https://*.rcrsv.io; " +
                $"font-src 'self' {dasCdn} https://fonts.gstatic.com https://*.rcrsv.io; " +
